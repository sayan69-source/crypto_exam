...
export default function CandidateEnrolment() {
  ...
  async function submit() {
    ...
    try {
      const j = await enrollApi.enrol({ fullName, dateOfBirth: dob, examId, locationPreferences: centerId ? [centerId] : [], subjectIds: [], faceDescriptor: faceDescriptor! });
      setResult({ rollNumber: j.rollNumber, centre: j.centre || "Assigned later", exam: j.exam });
