        ...
        <div className="wrap">
          ...
          <div className={s.valuesGrid}>
            {[
              ...
              { num: "VALUE 03", title: "Built for India, not retrofitted.", desc: "On-device biometric processing, DPDP Act 2023 alignment, and centres designed for the operating reality of Indian examination halls." },
            ].map((v) => (
