        ...
        <div className="wrap">
          ...
          <div className={s.rolesGrid}>
            {[
              ...
              { icon: "flask-conical", title: "Setter", tag: "Authoring portal", desc: "A dense authoring portal for composing papers, generating ZK difficulty proofs, and running red-team review.", href: "/for-setters", linkText: "View setter portal" },
