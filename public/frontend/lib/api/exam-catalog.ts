/**
 * CryptoExam Core â€” Comprehensive Exam Catalog
 * 
...
export const examCatalog: Exam[] = [
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    name: 'JEE Main 2026 â€” Session 2 (Paper 1: B.E./B.Tech)',
    name_hi: 'JEE à¤®à¥‡à¤¨ 2026 â€” à¤¸à¤¤à¥à¤° 2 (à¤ªà¥‡à¤ªà¤° 1: à¤¬à¥€.à¤ˆ./à¤¬à¥€.à¤Ÿà¥‡à¤•)',
    exam_body: 'NTA',
    subject_taxonomy: {
      subjects: [
        {
          name: 'Physics',
          name_hi: 'à¤­à¥Œà¤¤à¤¿à¤• à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨',
        ...
        {
          name: 'Chemistry',
          name_hi: 'à¤°à¤¸à¤¾à¤¯à¤¨ à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨',
    ...
    positive_marks: 4,
    negative_marking: 1,
    total_marks: 300, // 75 Qs Ã— 4 marks
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    name: 'JEE Advanced 2026 â€” Paper 1',
    name_hi: 'JEE à¤à¤¡à¤µà¤¾à¤‚à¤¸à¥à¤¡ 2026 â€” à¤ªà¥‡à¤ªà¤° 1',
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    subject_taxonomy: {
      subjects: [
        { name: 'Physics', name_hi: 'à¤­à¥Œà¤¤à¤¿à¤• à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨', topics: ['Mechanics', 'Optics', 'Electrodynamics', 'Thermodynamics', 'Modern Physics'], question_count: 45 },
        { name: 'Chemistry', name_hi: 'à¤°à¤¸à¤¾à¤¯à¤¨ à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨', topics: ['Organic', 'Inorganic', 'Physical Chemistry'], question_count: 45 },
        { name: 'Botany', name_hi: 'à¤µà¤¨à¤¸à¥à¤ªà¤¤à¤¿ à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨', topics: ['Plant Morphology', 'Cell Biology', 'Genetics', 'Ecology', 'Biotechnology'], question_count: 45 },
        { name: 'Zoology', name_hi: 'à¤ªà¥à¤°à¤¾à¤£à¥€ à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨', topics: ['Human Physiology', 'Animal Kingdom', 'Evolution', 'Reproduction'], question_count: 45 },
      ],
    },
    exam_type: 'ONLINE_CBT',
    ...
    positive_marks: 4,
    negative_marking: 1,
    total_marks: 720, // 180 Qs Ã— 4 marks
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    total_marks: 160, // 80 Qs Ã— 2 marks
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    total_marks: 200, // 100 Qs Ã— 2 marks
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // 10. ISI (Indian Statistical Institute) â€” B.Stat/B.Math Admission Test
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    id: 'exam-isi-bstat-2026',
    name: 'ISI Admission Test 2026 â€” B.Stat / B.Math (UGA)',
    exam_body: 'CUSTOM', // ISI Kolkata
    subject_taxonomy: {
      subjects: [
        {
          name: 'Mathematics (MCQ â€” Part A)',
          topics: ['Algebra', 'Number Theory', 'Combinatorics', 'Geometry', 'Calculus', 'Probability'],
          question_count: 30, // Section A: 30 MCQs
        },
        {
          name: 'Mathematics (Subjective â€” Part B)',
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // 11. CMI (Chennai Mathematical Institute) â€” B.Sc Entrance
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    id: 'exam-cmi-bsc-2026',
    name: 'CMI Entrance Exam 2026 â€” B.Sc (Mathematics & Computer Science)',
    exam_body: 'CUSTOM', // CMI Chennai
    subject_taxonomy: {
      subjects: [
        {
          name: 'Mathematics (Part A â€” Objective)',
        ...
        {
          name: 'Mathematics (Part B â€” Subjective)',
