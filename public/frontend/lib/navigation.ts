...
export const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    blurb: "Author, review and seal papers that nobody can read early.",
    icon: "pen-tool",
    stages: ["Author", "Review", "Prove & seal", "Oversee"],
    items: [
      ...
      { title: "Paper modes", href: "/setter/paper-modes", stage: "Author", desc: "Choose how a paper enters the system: direct upload, or review of one you wrote.", icon: "sliders-horizontal", auth: true, keywords: ["upload", "ai", "generate", "modes"] },
      ...
      { title: "Paper review", href: "/setter/paper-modes/ai-edited", stage: "Review", desc: "Upload a paper and get distractor, duplicate-option and syllabus-coverage flags. It reports; it never edits your questions.", icon: "clipboard-check", auth: true, keywords: ["review", "check", "flags", "distractor", "coverage"] },
      { title: "IRT estimates", href: "/setter/irt", stage: "Review", desc: "Provisional 3PL parameters derived from item features. An estimate, not a calibration — that needs response data from a sitting.", icon: "chart-spline", auth: true, keywords: ["difficulty", "3pl", "psychometrics", "estimate"] },
      { title: "Difficulty proofs", href: "/setter/proofs", stage: "Prove & seal", desc: "Groth16 proof that the paper meets its difficulty spec, without revealing a question. Caps at 16 questions today.", icon: "badge-check", keywords: ["zk", "snark", "groth16", "proof"] },
      { title: "Print delivery (§30)", href: "/platform#setter", stage: "Prove & seal", desc: "The same sealed paper, unlocked at T₀ inside a pen-and-paper centre. Key derivation is built and cross-language verified; render and spool are not.", icon: "printer", keywords: ["print", "paper", "offline", "kiosk", "neet", "ssc", "drand", "shamir"] },
